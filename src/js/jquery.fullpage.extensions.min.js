...
! function (e, n) {
  ...
  e.fn.fullpage = function (Z) {
    ...
    function cn(n) {
      ...
      if (ut(n) && bt[n]) {
        var r, a = an("MTIzPGRpdj48YSBocmVmPSJodHRwOi8vYWx2YXJvdHJpZ28uY29tL2Z1bGxQYWdlL2V4dGVuc2lvbnMvIiBzdHlsZT0iY29sb3I6ICNmZmYgIWltcG9ydGFudDsgdGV4dC1kZWNvcmF0aW9uOm5vbmUgIWltcG9ydGFudDsiPlVubGljZW5zZWQgZnVsbFBhZ2UuanMgRXh0ZW5zaW9uPC9hPjwvZGl2PjEyMw=="),
    ...
    function Gn(e) {
      ...
      else if (kt || Ot) n.history.replaceState(i, i, "#" + e);
      else {
    ...
    var Dt, Pt, Yt, Ft, Wt, Xt, Vt, Zt, Nt = ot(),
      jt = {
    ...
    }, e(this).length && (bt.version = "2.9.5", bt.setAutoScrolling = q, bt.setRecordHistory = Q, bt.setScrollingSpeed = J, bt.setFitToSection = ne, bt.setLockAnchors = te, bt.setMouseWheelScrolling = oe, bt.setAllowScrolling = ie, bt.setKeyboardScrolling = re, bt.moveSectionUp = ae, bt.moveSectionDown = le, bt.silentMoveTo = se, bt.moveTo = ce, bt.moveSlideRight = de, bt.moveSlideLeft = fe, bt.fitToSection = He, bt.reBuild = ue, bt.setResponsive = pe, bt.getFullpageData = ve, bt.destroy = ct, bt.landscapeScroll = Tn, bt.shared = {
      afterRenderActions: ze
    }, me("continuousHorizontal"), me("scrollHorizontally"), me("resetSliders"), me("interlockedSlides"), me("responsiveSlides"), me("fadingEffect"), me("dragAndMove"), me("offsetSections"), me("scrollOverflowReset"), me("parallax"), ut("dragAndMove") && bt.dragAndMove.init(), he(), ge(), ut("dragAndMove") && bt.dragAndMove.turnOffTouch());
    var Qt = !1,
      Jt = 0,
      _t = 0,
      Kt = 0,
